...
- **Endpoint**: `showcore-database-production-rds.XXXXXX.us-east-1.rds.amazonaws.com`
- **Port**: `5432`
...
- **Bucket Name**: `showcore-static-assets-YOUR_AWS_ACCOUNT_ID`
- **Region**: `us-east-1`
...
DATABASE_URL=postgresql://postgres:YOUR_PASSWORD_HERE@showcore-database-production-rds.XXXXXX.us-east-1.rds.amazonaws.com:5432/showcore
DIRECT_URL=postgresql://postgres:YOUR_PASSWORD_HERE@showcore-database-production-rds.XXXXXX.us-east-1.rds.amazonaws.com:5432/showcore
...
S3_BUCKET=showcore-static-assets-YOUR_AWS_ACCOUNT_ID
...
psql "postgresql://postgres:YOUR_PASSWORD@showcore-database-production-rds.XXXXXX.us-east-1.rds.amazonaws.com:5432/showcore"
...
VITE_S3_BUCKET=showcore-static-assets-YOUR_AWS_ACCOUNT_ID
```
...
aws s3 sync apps/web/public/ s3://showcore-static-assets-YOUR_AWS_ACCOUNT_ID/public/ \
  --profile showcore \
  --acl public-read

# Verify upload
aws s3 ls s3://showcore-static-assets-YOUR_AWS_ACCOUNT_ID/public/ \
  --profile showcore \
  --recursive
```
...
// After (S3)
const S3_BASE_URL = 'https://showcore-static-assets-YOUR_AWS_ACCOUNT_ID.s3.amazonaws.com';
...
```bash
# Test S3 access
aws s3 ls s3://showcore-static-assets-YOUR_AWS_ACCOUNT_ID/ --profile showcore
