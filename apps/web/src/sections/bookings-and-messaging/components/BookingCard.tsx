    ...
    >
      ...
      <div className="flex items-start justify-between gap-4 mb-4">
        ...
        <div className="flex flex-col items-end gap-2 flex-shrink-0">
          ...
          {unreadCount > 0 && (
            <div className="flex items-center gap-1 text-amber-800 dark:text-amber-100">
      ...
      <div className="flex items-center justify-between pt-4 border-t border-zinc-100 dark:border-zinc-800">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 text-zinc-600 dark:text-zinc-400 hover:text-amber-800 dark:hover:text-amber-100 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded-lg transition-colors"
            aria-label="Message"
          >
