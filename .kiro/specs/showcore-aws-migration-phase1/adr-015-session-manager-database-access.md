...
aws ssm start-session \
  ...
  --parameters '{
    "host":["showcore-database-production-rds.XXXXXX.us-east-1.rds.amazonaws.com"],
    "portNumber":["5432"],
...
1. **Bastion Instance**: i-XXXXXXXXXXXXXXXXX
   - Type: t3.nano
...
2. **Port Forwarding**: Active
   ...
   - Remote: showcore-database-production-rds.XXXXXX.us-east-1.rds.amazonaws.com:5432
